              ...
              children: [
                ...
                Container(
                    ...
                    child: ListView.separated(
                          ...
                          child: Row(
                            children: [
                              card[index]['name'] == 'Фреш роллы с креветкой'
                                  ? Image.asset(
                                      "assets/images/item1_basket_favorite.png")
                                      ...
                                      Row(
                                        children: [
                                          StatefulBuilder(builder:
                                              (context, setStateCount) {
                                            return Container(
                                              height: 35,
                                              decoration: BoxDecoration(
                                                  color:
                                                      const Color(0xFFF7FF88),
                                                  borderRadius:
                      ...
                      shrinkWrap: true,
                      itemCount: prefs.getString('card') != null
                          ? jsonDecode(prefs.getString('card')).length
                          : 0,
                  ...
                  child: Column(
                    children: [
                        ...
                        child: Row(
                          children: [
                            ...
                            Switch(
                              ...
                              activeTrackColor:
                                  const Color(0xFF646464).withOpacity(0.31),
                      ...
                      StatefulBuilder(builder: (context, setStatePriceOrder) {
                        ...
                        for (var i = 0;
                            i < jsonDecode(prefs.getString('card')).length;
                            i++) {
