                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            card[index]['weight'],
                                            style:
                                                TextStyle(color: const Color(0xFFFFFFFF).withOpacity(0.4), fontFamily: "Overpass-Bold", fontSize: 14),
                                          ),
                                          SizedBox(
                                            width: 140,
                                            height: 50,
                                            child: Text(
                                              ...
                                              maxLines: 3,
                                              style: TextStyle(
                                                  color: const Color(0xFFFFFFFF).withOpacity(0.5), fontFamily: "Overpass-Bold", fontSize: 12),
                                            ),
                                          ),
                                          const SizedBox(height: 5),
                                          Row(
